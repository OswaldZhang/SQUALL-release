...
# ====  ====
prefix = "/lustre1/zxzeng/bwqin/SQUALL_main/clustering/istar/data/OV_VisiumHD/"  #  /
output_prefix = "/lustre1/zxzeng/bwqin/SQUALL_main/clustering/ST-NET/data/OV_VisiumHD/OV1"    # 
tif_path = f"{prefix}20240709-LC_cut.tif"

prefix = "/lustre1/zxzeng/bwqin/SQUALL_main/clustering/istar/data/OV_Xenium/"  #  /
output_prefix = "/lustre1/zxzeng/bwqin/SQUALL_main/clustering/ST-NET/data/OV_Xenium/OVXenium_1"    # 
...
downsampled_img = img.resize((img.width // 4, img.height // 4))  # 
