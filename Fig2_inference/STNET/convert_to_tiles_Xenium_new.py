...
# === 参数 ===
tile_pixel_size = 224
resolution = np.array([0.22073106, 0.22072619])  # 单位：µm/pixel
...
print(f"✅ 处理完成，共生成 {len(tile_expr_df)} 个 tile（每个 tile 大小为 {tile_size_um_x:.2f} × {tile_size_um_y:.2f} µm）")
