...
prefix="/lustre1/zxzeng/bwqin/STORM_main/clustering/istar/data/breast_ours_rgbonly/"
...
echo "START imputing"
python impute_ours.py ${prefix} --epochs=50 --device=${device}  # train model from scratch
