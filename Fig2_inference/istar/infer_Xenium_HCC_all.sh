...
cell=All_marker  # number of most variable genes to impute
marker_path=/lustre1/zxzeng/bwqin/STORM_main/clustering/istar/data/OV_Xenium_all/Human_marker.pkl
marker_path=/lustre1/zxzeng/bwqin/STORM_main/clustering/istar/data/HCC_VisiumHD_all_new/Human_marker.pkl
prefix="/lustre1/zxzeng/bwqin/STORM_main/clustering/istar/data/HCC_Xenium_all_new/"
...
#python select_genes.py --cell=${cell} "${prefix}cnts.tsv" "${prefix}gene-names.txt" --marker_path  "${marker_path}"
...
python impute.py ${prefix} --load-saved --epochs=0 --device=${device}  # train model from scratch
