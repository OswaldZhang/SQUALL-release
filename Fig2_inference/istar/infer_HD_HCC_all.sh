...
marker_path=/lustre1/zxzeng/bwqin/STORM_main/clustering/istar/data/OV_VisiumHD_all/Human_marker.pkl

prefix="/lustre1/zxzeng/bwqin/STORM_main/clustering/istar/data/HCC_VisiumHD_all_new/"
