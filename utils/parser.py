...
def get_args():
    ...
    parser.add_argument(
        ...
        action='store_true',
        default=False,
        help='finetune with pretrained weight')
    parser.add_argument(
        '--vote',
        action='store_true',
        default=False,
        help='vote for slide classification')
    parser.add_argument(
        '--get_embedding',
        action='store_true',
        default=False,
    ...
    args.experiment_path = os.path.join('experiments', Path(args.config).stem, Path(args.config).parent.stem,
                                        args.exp_name)#every node have a mnt data
