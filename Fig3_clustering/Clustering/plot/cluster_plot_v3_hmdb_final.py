...
miso_dir = "inhouse/clustering_miso_hmdb_results"
storm_dir = "inhouse/results_clusters_hmdb"
spatialglue_dir = "/lustre1/zxzeng/bwqin/SQUALL_main/clustering/SpatialGlue/spatialglue_multi_hmdb_result"
expr_leiden_dir = "inhouse/results_clusters_hmdb_expr_leiden"
rgb_leiden_dir = "inhouse/results_clusters_hmdb_rgb_leiden"
raw_dir = "inhouse/hmdb"
folder = "inhouse/hmdb_inference_result"
hmid_list = ["HM0592","HM0013","HM0016","HM0461","HM0555","HM0564","HM0591","HM1180","HM1310","HM1332","HM1350","HM1441","HM1581","HM1727","HM1969","HM2328","HM2493","HM2825","HM3044"]
def plot_clusters_comparison(hmid, save_path):
    ...
    # SQUALL
    storm_df = pd.read_csv(os.path.join(storm_dir, f"{hmid}_clusters.csv"), names=["barcode", "cluster"], header=0)
...
# ==========  ==========
os.makedirs("comparison_plots_raw_hmdb_7panel_blind", exist_ok=True)
for hmid in hmid_list:
    out_path = f"comparison_plots_raw_hmdb_7panel_blind/{hmid}_compare_all_methods_7panel.pdf"
    try:
