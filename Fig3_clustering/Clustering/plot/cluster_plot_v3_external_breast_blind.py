...
storm_dir = "external_breast/results_clusters_breast_external"
miso_dir = "external_breast/clustering_miso_GSE230098_results"
spatialglue_dir = "/lustre1/zxzeng/bwqin/SQUALL_main/clustering/SpatialGlue/spatialglue_multi_GSE230098_result"
expr_leiden_dir = "external_breast/results_clusters_breast_external_expr_leiden"
rgb_leiden_dir = "external_breast/results_clusters_external_breast_rgb_leiden"
raw_dir = "external_breast/GSE230098"
folder = "external_breast/intergrate_GSE230098_offset"
...
def plot_clusters_comparison(hmid, save_path):
    ...
    # SQUALL
    storm_df = pd.read_csv(os.path.join(storm_dir, f"{hmid}_rgb_clusters.csv"), names=["barcode", "cluster"], header=0)
...
# ==========  ==========
os.makedirs("comparison_plots_raw_external_breast_rgb_blind_7panel_expr", exist_ok=True)
for hmid in hmid_list:
    out_path = f"comparison_plots_raw_external_breast_rgb_blind_7panel_expr/{hmid}_compare_all_methods_7panel.pdf"
    try:
